...
class ObjectlinksApi:
    ...
    def objectlinks_create(
        self,
        objectlinks_create_model: Annotated[Optional[AnyectlinksCreateModel], Field(description="request_data   ")] = None,
        ...
        :type objectlinks_create_model: AnyectlinksCreateModel
