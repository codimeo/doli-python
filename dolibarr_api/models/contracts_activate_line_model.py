...
class ContractsActivateLineModel(BaseModel):
    """
    ContractsActivateLineModel
    """ # noqa: E501
    datestart: StrictStr = Field(description="Date start")
    dateend: Optional[StrictStr] = Field(default=None, description="Date end")
    comment: Optional[StrictStr] = Field(default=None, description="Comment")
    __properties: ClassVar[List[str]] = ["datestart", "dateend", "comment"]
