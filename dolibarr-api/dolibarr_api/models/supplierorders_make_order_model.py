...
class SupplierordersMakeOrderModel(BaseModel):
    """
    SupplierordersMakeOrderModel
    """ # noqa: E501
    var_date: StrictInt = Field(description="Date (unix timestamp in sec)", alias="date")
    method: StrictInt = Field(description="Method")
    comment: Optional[StrictStr] = Field(default=None, description="Comment")
    __properties: ClassVar[List[str]] = ["date", "method", "comment"]
